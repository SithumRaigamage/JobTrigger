    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: LoadingOverlay(
          isLoading: isLoading,
          // Narrower than the default ResponsiveCenter max width -- a
          // form reads better constrained close to its own natural width,
          // matching LoginScreen's narrow-layout form width.
